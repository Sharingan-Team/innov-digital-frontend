...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Step 2: Continue with login logic (send data to backend)
    console.log('Final login data:', formData);
    // TODO: Implement actual backend login submission here
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 relative">
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md z-10">
        <h2 className="text-2xl font-bold mb-6 text-center">Login - Step {step}</h2>
